...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Teaser.css_class'
        db.add_column(u'djangocms_teaser_teaser', 'css_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Teaser.css_class'
        db.delete_column(u'djangocms_teaser_teaser', 'css_class')
